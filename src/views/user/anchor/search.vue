  ...
  <div class="g-search">
    <el-form class="g-search-form el-form-block" size="small" :inline="inline" ref="searchForm" :model="search" :rules="rules" label-width="100px">
      <div class="g-search-left">
        <el-form-item label="管理员名称" prop="product_name">
          <el-input placeholder="请输入管理员名称" v-model="search.product_name"></el-input>
        </el-form-item>
        <el-form-item label="管理员账户" prop="product_name">
          <el-input placeholder="请输入管理员账户" v-model="search.product_name"></el-input>
        </el-form-item>
